...
import com.agx.aicodemother.common.DeleteRequest;
...
public class AppController {
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        ThrowUtils.throwIf(!file.exists() || !file.isDirectory(), ErrorCode.NOT_FOUND_ERROR, "应用代码不存在，请先生成代码");
        // 6. 生成下载文件名(不要含中文)
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.agx.aicodemother.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
